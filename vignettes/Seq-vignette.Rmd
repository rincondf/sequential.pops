...
sample size with sample sizes of 20 and 30 producing less incorrect decisions,
particularly when the true incidence is below the threshold.

### Example 3: Testing if a population density is above a dynamic threshold

Sometimes hypothesis of population densities are not single numbers, but entire
