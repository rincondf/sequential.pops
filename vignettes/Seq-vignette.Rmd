...
Now let's generate some data with the same specifications as in example 2, and 
including the function `estimate_k` to obtain overdispersion as a function of
the mean:
```{r}
counts1a <- rnbinom(20, mu = 5, size = estimate_k(5))
counts1a
...
size that follows a negative binomial distribution with an overdispersion determined
from `estimate_k`. 
